...
<html lang="cs">
  <head>
    ...
    <title>Vrata Šnábl | Vrata Šnábl</title>
  ...
  <body class="old-url-redirect">
    <main class="old-url-card">
      <h1>Vrata Šnábl</h1>
      <p>Pokračujte na aktuální hlavní stránku. Pokud se stránka nepřesměruje automaticky, pokračujte přes tlačítko.</p>
      <a class="btn btn-primary" href="/">Pokračovat</a>
    </main>
  </body>
</html>
